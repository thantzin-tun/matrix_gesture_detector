...
import 'dart:math';library matrix_gesture_detector;
...
class MatrixGestureDetector extends StatefulWidget {
  ...
  final MatrixGestureDetectorCallback onMatrixUpdateEnd;
...
class _MatrixGestureDetectorState extends State<MatrixGestureDetector> {
  ...
  void onScaleUpdate(ScaleUpdateDetails details) {
    ...
    widget.onMatrixUpdateEnd(matrix,translationDeltaMatrix,scaleDeltaMatrix,rotationDeltaMatrix);
  }
